...
| <b>alphaImageUrl</b>([<i>url</i>]) | Getter/setter for the URL of the image used to create a [alpha map](https://threejs.org/docs/#api/en/materials/MeshBasicMaterial.alphaMap) in the material, to give the globe transparent/opaque effect. | `null` |
